...
_1845: (x0,x1) => x0.exec(x1),
_1846: (x0,x1) => x0.test(x1),
_1847: (x0,x1) => x0.exec(x1),
_1848: (x0,x1) => x0.exec(x1),
_1849: x0 => x0.pop(),
_1853: (x0,x1,x2) => x0[x1] = x2,
_1855: o => o === undefined,
_1856: o => typeof o === 'boolean',
_1857: o => typeof o === 'number',
_1859: o => typeof o === 'string',
_1862: o => o instanceof Int8Array,
_1863: o => o instanceof Uint8Array,
_1864: o => o instanceof Uint8ClampedArray,
_1865: o => o instanceof Int16Array,
_1866: o => o instanceof Uint16Array,
_1867: o => o instanceof Int32Array,
_1868: o => o instanceof Uint32Array,
_1869: o => o instanceof Float32Array,
_1870: o => o instanceof Float64Array,
_1871: o => o instanceof ArrayBuffer,
_1872: o => o instanceof DataView,
_1873: o => o instanceof Array,
_1874: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1876: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1877: o => o instanceof RegExp,
_1878: (l, r) => l === r,
_1879: o => o,
_1880: o => o,
_1881: o => o,
...
_1888: l => arrayFromDartList(Int8Array, l),
_1889: (data, length) => {
...
_1890: l => arrayFromDartList(Uint8ClampedArray, l),
_1891: l => arrayFromDartList(Int16Array, l),
_1892: l => arrayFromDartList(Uint16Array, l),
_1893: l => arrayFromDartList(Int32Array, l),
_1894: l => arrayFromDartList(Uint32Array, l),
_1895: l => arrayFromDartList(Float32Array, l),
_1896: l => arrayFromDartList(Float64Array, l),
_1897: (data, length) => {
...
_1898: l => arrayFromDartList(Array, l),
_1899:       (s, length) => {
        if (length == 0) return '';
...
_1908: (o, p) => o[p],
_1909: (o, p, v) => o[p] = v,
_1910: (o, m, a) => o[m].apply(o, a),
_1912: o => String(o),
_1913: (p, s, f) => p.then(s, f),
_1914: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_2032: (x0,x1) => x0.withCredentials = x1,
_2034: x0 => x0.responseURL,
_2035: x0 => x0.status,
_2036: x0 => x0.statusText,
_2038: (x0,x1) => x0.responseType = x1,
_2039: x0 => x0.response,
_3851: () => globalThis.window,
_3915: x0 => x0.navigator,
